...
open_window
check "only the live rows, Apple's with the logo and ggml's with its squared G" \
    "[\"Apple dictation (built in) $apple_logo\",\"Apple long-form (built in) $apple_logo\",\"Nemotron \\\"streaming\\\" (Q8_0) $ggml_mark\",\"Download Models...\"]" \
