...
- `fingerprint` - from the [`replay`](https://github.com/abra-code/replay) repository. Speech uses it to tell a transcript it saved, untouched since, from one it must not replace.
